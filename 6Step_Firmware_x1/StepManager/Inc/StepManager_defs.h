...
#define RAMP_CURRENT_REF 83
#define RAMP_TABLE_ENTRIES 39
#define RAMP_END_ENTRY 19 //which entry to stop ramp
#define RAMP_EXIT_CURRENT 20

//RUN STATE DEFINTIONS
#define ZC_DETECTIONS_FOR_VALID 2
#define BEMF_ZC_THRESH 50
#define DEMAG_NUM_PERIODS 4
